...
public abstract class AbstractBlockWaterPurifier<T extends AbstractTileWaterPurifier> extends BlockContainer {
    public static final PropertyDirection FACING = BlockHorizontal.FACING;
    public static final PropertyBool ENABLED = PropertyBool.create("enabled");

    private final Class<T> tileClass;

    public AbstractBlockWaterPurifier(Material material, Class<T> tileClass) {
        super(material);
