...
public class ItemPortablePurifier extends AbstractRFItem implements IFluidContainerItem, IBauble, IItemAddition {
    protected int fluidCapacity;
    protected int fluidCost;

    public ItemPortablePurifier() {
        this.setRegistryName(SurvivalTools.MOD_ID, PORTABLE_PURIFIER);
