...
public class ItemHydrationPack extends AbstractEquipableBauble implements IPurifiedFluidContainerItem, IItemAddition {
    protected int capacity;
    protected int fluidCost;
    protected int restoredThirst;
    protected float restoredHydration;

    public ItemHydrationPack(String unlocName, int maxCapacity) {
        super(unlocName);
