...
public class SubTilePurePitcher extends SubTileFunctional implements IFluidHandler, IAddition, IProxy {
    ...
    public int getFluidGeneration() {
        return ConfigHandlerST.integrations.botania.pure_pitcher.fluidGeneration;
    }
    ...
    public boolean isEnabled() {
        return ConfigHandlerST.integrations.botania.pure_pitcher.enable && SurvivalToolsAPI.isThirstFeatureEnabled();
    }
}
