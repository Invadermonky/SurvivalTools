package com.invadermonky.survivaltools.compat.naturesaura.items;
...
public class ItemEnvironmentalAmulet extends AbstractEquipableBauble {
    public ItemEnvironmentalAmulet() {
        super(LibNames.ENVIRONMENTAL_AMULET);
    }
