package com.invadermonky.survivaltools.compat.thaumcraft.items;
...
public class ItemThaumicRegulator extends AbstractEquipableBauble implements IRechargable, IProxy {
    public ItemThaumicRegulator() {
        super(LibNames.THAUMIC_REGULATOR);
    ...
    */
    ...
    public void registerRecipe(IForgeRegistry<IRecipe> registry) {
        ThaumcraftApi.addInfusionCraftingRecipe(new ResourceLocation(SurvivalTools.MOD_ID, "ThaumicRegulator"), new InfusionRecipe(
                "THAUMICREGULATOR",
                new ItemStack(ModItemsST.THAUMIC_REGULATOR),
                5,
